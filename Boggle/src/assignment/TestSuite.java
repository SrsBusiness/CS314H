...
public class TestSuite{
    public static void main(String[] args) throws IOException{
        ...
        */
        ...
        GameDictionary d = new GameDictionary();
        d.loadDictionary("words.txt");
        g.newGame(2,2,"cubes.txt",d);
        for(int i = 0; i < 10; i++){
            g.setGame(readBoard("board" + i + ".txt"));
            saveWords(g.getAllWords(), "words" + i + ".txt");
        } 
        */
        ...
        d.loadDictionary("words.txt");
        g.newGame(2,2, "cubes.txt", d);
        g.setGame(readBoard("dogs.txt"));
        printBoard(g.getBoard());
        System.out.println(g.addWord("dogs", 0));
        */
        ...
        g.newGame(2,2,"cubes.txt", d);
        g.setGame(readBoard("dogs.txt"));
        System.out.println(g.getAllWords());
    }
    ...
    public static void createDict(int size, String file) throws IOException{
