...
public class JBetterBrainTetris extends JTetris {
	...
	// You can create a JTetris or BetterJBrainTetris here
	final int pixels = 16;
	JTetris tetris = new JBetterBrainTetris(WIDTH*pixels+2, 
