...
public class NoGUIEvolutionChamber{
    ...
    protected int individuals = 20;
    protected BetterBrain[] brains = new BetterBrain[individuals];
    protected double[][] champs = new double[5][BetterBrain.WEIGHTS];
    protected int[] highScores = new int[5];
    protected int generations = 50;
    protected int trials = 80;
    protected Random random = new Random();
    public NoGUIEvolutionChamber(){
        pieces = TetrisPiece.getPieces();
        for(int i = 0; i < individuals; i++){
            brains[i] = new BetterBrain();
        }
        readWeights();
    }
    ...
    public void breed(){
        for(int i = 0; i < individuals; i++){
            ...
            double[] child= new double[BetterBrain.WEIGHTS];
            for(int j = 0; j < BetterBrain.WEIGHTS; j++){
